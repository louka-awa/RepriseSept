            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width: 150px; float: right; display: inline-block;" href="{{ url('administrateur/add-edit-category') }}" class="btn btn-block btn-primary">Add Category</a>
                                ...
                                <tbody>
                                  @foreach($categories as $category)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('administrateur/add-edit-category/'.$category['id']) }}"><i style="font-size:25px;" class="mdi mdi-pencil-box"></i></a>
                                            <?php /* <a title="Category" class="confirmDelete" href="{{ url('administrateur/delete-category/'.$category['id']) }}"><i style="font-size:25px;" class="mdi mdi-file-excel-box"></i></a> */ ?>
