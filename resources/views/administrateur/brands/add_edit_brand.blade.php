            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" @if(empty($brand['id'])) action="{{ url('administrateur/add-edit-brand') }}" @else action="{{ url('administrateur/add-edit-brand/'.$brand['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
