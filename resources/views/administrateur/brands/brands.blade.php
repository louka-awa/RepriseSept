            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width: 150px; float: right; display: inline-block;" href="{{ url('administrateur/add-edit-brand') }}" class="btn btn-block btn-primary">Add Brand</a>
                                ...
                                <tbody>
                                  @foreach($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('administrateur/add-edit-brand/'.$brand['id']) }}"><i style="font-size:25px;" class="mdi mdi-pencil-box"></i></a>
                                            <?php /* <a title="Brand" class="confirmDelete" href="{{ url('administrateur/delete-brand/'.$brand['id']) }}"><i style="font-size:25px;" class="mdi mdi-file-excel-box"></i></a> */ ?>
