...
namespace App\Http\Controllers\Admininistrateur;
...
use App\Models\admininistrateur;
...
class admininistrateurController extends Controller
{
    ...
    public function updateAdminPassword(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if(Hash::check($data['current_password'],Auth::guard('admin')->user()->password)){
                ...
                if($data['confirm_password']==$data['new_password']){
                    admininistrateur::where('id',Auth::guard('admin')->user()->id)->update(['password'=>bcrypt($data['new_password'])]);
        ...
        $adminDetails = admininistrateur::where('email',Auth::guard('admin')->user()->email)->first()->toArray();
    ...
    public function updateAdminDetails(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            admininistrateur::where('id',Auth::guard('admin')->user()->id)->update(['name'=>$data['admin_name'],'mobile'=>$data['admin_mobile'],'image'=>$imageName]);
    ...
    public function updateVendorDetails($slug, Request $request){
        if($slug=="personal"){
            ...
            if($request->isMethod('post')){
                ...
                admininistrateur::where('id',Auth::guard('admin')->user()->id)->update(['name'=>$data['vendor_name'],'mobile'=>$data['vendor_mobile'],'image'=>$imageName]);
    ...
    public function viewVendorDetails($id){
        $vendorDetails = admininistrateur::with('vendorPersonal','vendorBusiness','vendorBank')->where('id',$id)->first();
    ...
    public function updateAdminStatus(Request $request){
        if($request->ajax()){
            ...
            admininistrateur::where('id',$data['admin_id'])->update(['status'=>$status]);
            $adminDetails = admininistrateur::where('id',$data['admin_id'])->first()->toArray();
