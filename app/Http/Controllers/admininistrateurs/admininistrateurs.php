...
use Hash;
use Auth;
use App\Models\admininistrateurs;
...
class admininistrateursController extends Controller
{
    ...
    public function updateAdminPassword(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            if(Hash::check($data['current_password'],Auth::guard('admin')->user()->password)){
                ...
                if($data['confirm_password']==$data['new_password']){
                    admininistrateurs::where('id',Auth::guard('admin')->user()->id)->update(['password'=>bcrypt($data['new_password'])]);
        ...
        $adminDetails = admininistrateurs::where('email',Auth::guard('admin')->user()->email)->first()->toArray();
    ...
    public function updateAdminDetails(Request $request){
        ...
        if($request->isMethod('post')){
            ...
            admininistrateurs::where('id',Auth::guard('admin')->user()->id)->update(['name'=>$data['admin_name'],'mobile'=>$data['admin_mobile'],'image'=>$imageName]);
    ...
    public function updateVendorDetails($slug, Request $request){
        if($slug=="personal"){
            ...
            if($request->isMethod('post')){
                ...
                admininistrateurs::where('id',Auth::guard('admin')->user()->id)->update(['name'=>$data['vendor_name'],'mobile'=>$data['vendor_mobile'],'image'=>$imageName]);
    ...
    public function admins($type=null){
        $admins = admininistrateurs::query();
        if(!empty($type)){
    ...
    public function viewVendorDetails($id){
        $vendorDetails = admininistrateurs::with('vendorPersonal','vendorBusiness','vendorBank')->where('id',$id)->first();
    ...
    public function updateAdminStatus(Request $request){
        if($request->ajax()){
            ...
            admininistrateurs::where('id',$data['admin_id'])->update(['status'=>$status]);
            $adminDetails = admininistrateurs::where('id',$data['admin_id'])->first()->toArray();
