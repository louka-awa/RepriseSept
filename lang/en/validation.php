...
return [
    ...
    */
    ...
    'exists' => 'La valeur sélectionnée de :attribute est invalide ou le mot de passe est erroné',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger notre attribut de substitution
    | par quelque chose de plus convivial pour le lecteur, tel que "Adresse e-mail" à la place de "email".
